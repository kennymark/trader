...
import { assignCategories, computeOpportunityScores } from "./scoring";
import { defaultAssumptionsFromFundamentals, simulateScenarios } from "./scenarios";
import { findHistoricalPatterns } from "./patterns";
