...
primary_target: "apps/web/src/pages/HomePage.tsx"
related_targets: ["apps/web/src/components/AppShell.tsx","apps/web/src/pages/PortfolioPage.tsx","apps/web/src/styles.css"]
---

Scope: the whole application interface, entered at the watchlist. Visitor mode: Operate.

Audience: the owner, a UK retail investor reviewing decisions already made, at a desk,
after hours. Job: read what actually happened to their money and face what a past sell
cost. Constraints: GBP and Freetrade truth, Yahoo prices, five surfaces of equal standing.

Memorable moment: the never-sold replay, stated in words and money before any chart.

Unresolved: whether the ruled table survives at phone width or becomes stacked records.
